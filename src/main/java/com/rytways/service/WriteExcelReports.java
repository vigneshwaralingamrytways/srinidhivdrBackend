...
//	       
			List<String> formItems = Arrays.asList(formConfig.getItemOne(), formConfig.getItemTwo(),
					formConfig.getItemThree(), formConfig.getItemFour(), formConfig.getItemFive(),
					formConfig.getItemSix(), formConfig.getItemSeven(), formConfig.getItemEight(),
					formConfig.getItemNine(), formConfig.getItemTen(), formConfig.getItemEleven(),
					formConfig.getItemTwelve(), formConfig.getItemThirteen(), formConfig.getItemFourteen(),
					formConfig.getItemFifteen());
		...
		for (DocumentTransaction doc : docList) {
			...
			row.createCell(cellNum++)
					.setCellValue(doc.getFolderMaster() != null ? doc.getFolderMaster().getFolderCategoryName() : ""); // Folder
																														// Name
			row.createCell(cellNum++).setCellValue(
					doc.getSubFolderMaster() != null ? doc.getSubFolderMaster().getSubFolderCategoryName() : ""); // Sub
																													// Folder
			if (formConfigOpt.isPresent()) { // Name

				// Add dynamic cell values from DocumentTransaction
				List<String> docItems = Arrays.asList(doc.getItemOne(), doc.getItemTwo(), doc.getItemThree(),
						doc.getItemFour(), doc.getItemFive(), doc.getItemSix(), doc.getItemSeven(), doc.getItemEight(),
						doc.getItemNine(), doc.getItemTen(), doc.getItemEleven(), doc.getItemTwelve(),
	...
	public StreamingResponseBody ExporExcel(List<SubFolderMaster> subFolderList) throws IOException {
		...
		List<String> formItems = Arrays.asList(formConfig.getItemOne(), formConfig.getItemTwo(),
				formConfig.getItemThree(), formConfig.getItemFour(), formConfig.getItemFive(), formConfig.getItemSix(),
				formConfig.getItemSeven(), formConfig.getItemEight(), formConfig.getItemNine(), formConfig.getItemTen(),
				formConfig.getItemEleven(), formConfig.getItemTwelve(), formConfig.getItemThirteen(),
				formConfig.getItemFourteen(), formConfig.getItemFifteen());
...
//	        DocumentTransaction doc =  
			...
			row.createCell(cellNum++)
					.setCellValue(doc != null && doc.getDocumentTypeMaster() != null
							? doc.getDocumentTypeMaster().getDocumentType()
							: "");

			row.createCell(cellNum++).setCellValue(
					doc != null && doc.getFolderMaster() != null ? doc.getFolderMaster().getFolderCategoryName() : "");

			row.createCell(cellNum++).setCellValue(
					subFolder.getSubFolderCategoryName() != null ? subFolder.getSubFolderCategoryName() : "");

			if (doc != null) {
				List<String> items = Arrays.asList(doc.getItemOne(), doc.getItemTwo(), doc.getItemThree(),
						doc.getItemFour(), doc.getItemFive(), doc.getItemSix(), doc.getItemSeven(), doc.getItemEight(),
						doc.getItemNine(), doc.getItemTen(), doc.getItemEleven(), doc.getItemTwelve(),
						doc.getItemThirteen(), doc.getItemFourteen(), doc.getItemFifteen());
